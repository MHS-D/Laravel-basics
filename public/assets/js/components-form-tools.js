var ComponentsFormTools = function () {
    ...
    var handleInputMasks = function () {
        ...
        $("#birth_date").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#date").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#bus_start").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#bus_end").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#pay_line_bus").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#pay_line").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#sstart_dat").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#sint_view").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#squit_dt").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        $("#ssubmit_dt").inputmask("d/m/y", {
            autoUnmask: true
        }); //direct mask 
        ...
        $("#sphone1").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#sphone2").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#sphone3").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#sphone4").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#sphone5").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#sphone6").inputmask("mask", {
            "mask": "(999) 9-999999"
        }); //specifying fn & options
        $("#spons_pho").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#driver_ph").inputmask("mask", {
            "mask": "(999) 99-999999"
        }); //specifying fn & options
        $("#mask_tin").inputmask({
            "mask": "99-9999999",
        ...
        $("#payment").inputmask('L.L. 999,999,999', {
            numericInput: true,
            rightAlignNumerics: false,
            greedy: false
        }); //123456  =>  € ___.__1.234,56
